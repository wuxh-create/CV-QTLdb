              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1"${_scopeId3}> Search InDel-GWAS by Variant or Indicator </div>`);
                      } else {
                        return [
                          createVNode("div", { class: "full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1" }, " Search InDel-GWAS by Variant or Indicator ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_q_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="col-12 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Variant ID:</span>`);
                        ...
                        _push4(`</div><div class="col-12 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Indicator Type:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                        ...
                        _push4(`</div><div class="col-12 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Indicator name:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                        ...
                        _push4(`</div><div class="col-12"${_scopeId3}><div class="row items-center justify-center q-gutter-x-xl"${_scopeId3}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/gwas/indel.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=indel.vue.mjs.map
