...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formImputed = computed(() => {
      ...
      return phenotypeTypeNotEmpty || phenotypeIDNotEmpty || indicatorTypeNotEmpty || indicatorNameNotEmpty;
    });
    const examples = [
      {
        label: "example1",
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_q_dialog, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card, { style: { "width": "400px", "height": "400px" } }, {
                  ...
                  return [
                    createVNode(_component_q_card, { style: { "width": "400px", "height": "400px" } }, {
                      default: withCtx(() => [
                        createVNode(_component_q_card_section, null, {
                          default: withCtx(() => [
                            createVNode(_component_q_img, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-px-md q-py-sm text-subtitle2 text-primary text-bold" style="${ssrRenderStyle({ "background-color": "#e3f2fd", "font-size": "20px", "line-height": "1.3" })}"${_scopeId3}> Search Correaltion by Phenotype or Indicator </div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "q-px-md q-pt-md q-pb-sm" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-body1 text-grey-8" style="${ssrRenderStyle({ "line-height": "1.7" })}"${_scopeId3}> This module provides comprehensive pairwise correlations identified from 148 healthy Chinese individuals, revealing regulatory connections between genetic variants, molecular phenotypes, and clinical traits. The correlation dataset integrates multi-omics associations, including colocalization between <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> genetic variants and molecular phenotypes (eQTL, sQTL, apaQTL, meQTL), </span> colocalization between <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> molecular phenotypes and clinical traits, </span> and mediation relationships linking <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> variants → molecular phenotypes → clinical outcomes. </span><br${_scopeId3}></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            ...
                            createTextVNode(" This module provides comprehensive pairwise correlations identified from 148 healthy Chinese individuals, revealing regulatory connections between genetic variants, molecular phenotypes, and clinical traits. The correlation dataset integrates multi-omics associations, including colocalization between "),
                            createVNode("span", {
                            ...
                            createTextVNode(" colocalization between "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " molecular phenotypes and clinical traits, "),
                            createTextVNode(" and mediation relationships linking "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                  ...
                  _push3(ssrRenderComponent(_component_q_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="row"${_scopeId3}><div class="col-12 col-sm-4 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Phenotype Type:</span>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_table, {
                    ...
                    columns: unref(model_correlation),
                    dense: small_screen.value,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/correlation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=correlation.vue.mjs.map
