...
import { m as model_gwas } from './TableGWAS.mjs';
...
import { _ as __nuxt_component_1, a as __nuxt_component_4$1, b as __nuxt_component_5, c as __nuxt_component_9, d as __nuxt_component_13, e as __nuxt_component_11, f as __nuxt_component_12, g as __nuxt_component_10 } from '../_/QInnerLoading.mjs';
import { _ as __nuxt_component_2 } from '../_/QCard.mjs';
import { _ as __nuxt_component_3 } from '../_/QCardSection.mjs';
import { _ as __nuxt_component_4 } from '../_/QImg.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const query_indicator_type = ref(null);
    const query_indicator_name = ref(null);
    ...
    const indicator_name_options = ref([]);
    ...
    const onIndicatorNameInput = (val, update, abort) => {
      update(() => {
        if (val === "") {
    ...
    const formImputed = computed(() => {
      ...
      return variantTypeNotEmpty || variantIDNotEmpty || indicatorTypeNotEmpty || indicatorNameNotEmpty;
    });
    const examples = [
      {
        label: "example1",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_q_form = __nuxt_component_4$1;
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_q_dialog, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card, { style: { "width": "600px", "height": "480px" } }, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_q_img, {
                                src: "data:image/png;base64," + plot_data.value,
                                "spinner-color": "white",
                                fit: "scale-down"
                  ...
                  return [
                    createVNode(_component_q_card, { style: { "width": "600px", "height": "480px" } }, {
                      default: withCtx(() => [
                        createVNode(_component_q_card_section, null, {
                          default: withCtx(() => [
                            createVNode(_component_q_img, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-px-md q-py-sm text-subtitle2 text-primary text-bold" style="${ssrRenderStyle({ "background-color": "#e3f2fd", "font-size": "20px", "line-height": "1.3" })}"${_scopeId3}> Search GWAS by Variant or Indicator </div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "q-px-md q-pt-md q-pb-sm" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-body1 text-grey-8" style="${ssrRenderStyle({ "line-height": "1.7" })}"${_scopeId3}> This module provides <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 101,292 </span> genome-wide association results identified from 148 healthy Chinese individuals, linking genetic variants to <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 162 clinical traits </span> spanning pathological, metabolic, hormonal, anthropometric, imaging, nutritional, environmental toxin categories, and questionnaire-based assessments. The GWAS dataset comprises associations derived from four variant types: <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 89,104 </span> SNV associations, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 6,707 </span> InDel associations, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 4,185 </span> MNV associations, and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 1,296 </span> SV associations. <br${_scopeId3}></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            ...
                            createTextVNode(" This module provides "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 101,292 "),
                            createTextVNode(" genome-wide association results identified from 148 healthy Chinese individuals, linking genetic variants to "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 162 clinical traits "),
                            createTextVNode(" spanning pathological, metabolic, hormonal, anthropometric, imaging, nutritional, environmental toxin categories, and questionnaire-based assessments. The GWAS dataset comprises associations derived from four variant types: "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 89,104 "),
                            createTextVNode(" SNV associations, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 6,707 "),
                            createTextVNode(" InDel associations, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 4,185 "),
                            createTextVNode(" MNV associations, and "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 1,296 "),
                            createTextVNode(" SV associations. "),
                            createVNode("br")
                          ])
                        ];
                      }
                  ...
                  _push3(ssrRenderComponent(_component_q_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`</div></div><div class="row"${_scopeId3}><div class="col-12 col-sm-4 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Indicator Type:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                          ...
                          "input-class": "text-primary",
                          modelValue: query_indicator_type.value,
                          "onUpdate:modelValue": ($event) => query_indicator_type.value = $event,
                          options: indicator_type_options
                        }, null, _parent4, _scopeId3));
                        _push4(`</div><div class="col-12 col-sm-8 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Indicator name:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                          ...
                          class: "col-sm-4 col-12 q-px-sm q-py-xs",
                          "input-class": "text-primary",
                          modelValue: query_indicator_name.value,
                          "onUpdate:modelValue": ($event) => query_indicator_name.value = $event,
                          options: indicator_name_options.value,
                          onFilter: onIndicatorNameInput,
                          ref_key: "ref_indicator_name",
                        ...
                        return [
                          ...
                          createVNode("div", { class: "row" }, [
                            createVNode("div", { class: "col-12 col-sm-4 items-center justify-between q-my-xs" }, [
                              createVNode("span", { class: "text-bold text-subtitle2 text-primary q-px-sm" }, "Indicator Type:"),
                              createVNode(_component_q_select, {
                                dense: "",
                                outlined: "",
                                clearable: "",
                            ...
                            createVNode("div", { class: "col-12 col-sm-8 items-center justify-between q-my-xs" }, [
                              createVNode("span", { class: "text-bold text-subtitle2 text-primary q-px-sm" }, "Indicator name:"),
                              createVNode(_component_q_select, {
                                dense: "",
                                outlined: "",
                                clearable: "",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/gwas/index.vue");
