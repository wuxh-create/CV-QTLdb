...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const examples = [
      {
        label: "example1",
        variantID: "chr4_39444929_G_A",
        phenotypeType: "eQTL",
        phenotypeID: "ENSG00000163682.17",
        disable: false
      },
      {
        label: "example2",
        variantID: null,
        phenotypeType: "sQTL",
        phenotypeID: "chr4:168396124:168400826:clu_39765_-",
        disable: false
      },
      {
        label: "example3",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1"${_scopeId3}> Search SNV-QTL by Variant or Phenotype </div>`);
                      } else {
                        return [
                          createVNode("div", { class: "full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1" }, " Search SNV-QTL by Variant or Phenotype ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_q_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="column q-gutter-y-md"${_scopeId3}><div${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Variant ID:</span>`);
                        ...
                        _push4(`</div><div${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Phenotype Type:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                        ...
                        _push4(`</div><div${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Phenotype ID:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                        ...
                        return [
                          createVNode("div", { class: "column q-gutter-y-md" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/qtl/snp.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=snp.vue2.mjs.map
