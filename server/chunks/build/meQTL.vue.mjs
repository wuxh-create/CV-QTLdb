              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-px-md q-py-sm text-subtitle2 text-primary text-bold" style="${ssrRenderStyle({ "background-color": "#e3f2fd", "font-size": "20px", "line-height": "1.3" })}"${_scopeId3}> Search meQTL by Variant or Gene </div>`);
                      } else {
                        return [
                          createVNode("div", {
                  ...
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "q-px-md q-pt-md q-pb-sm" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-body1 text-grey-8" style="${ssrRenderStyle({ "line-height": "1.5" })}"${_scopeId3}> This module provides <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 10,537,458 </span> meQTLs identified across 148 healthy Chinese individuals. The meQTL dataset links genetic variants to DNA methylation levels at <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 13,757,124 </span> high-quality CpG sites genome-wide, encompassing <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 5,344,683 </span> cis-meQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 4,002,871 </span> trans-meQTL pairs from SNVs, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 392,720 </span> cis-meQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 287,376 </span> trans-meQTL pairs from InDels, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 296,675 </span> cis-meQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 168,050 </span> trans-meQTL pairs from MNVs, and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 21,305 </span>cis-meQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 23,778 </span> trans-meQTL pairs from SVs.<br${_scopeId3}></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            ...
                            createTextVNode(" meQTLs identified across 148 healthy Chinese individuals. The meQTL dataset links genetic variants to DNA methylation levels at "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 13,757,124 "),
                            createTextVNode(" high-quality CpG sites genome-wide, encompassing "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 5,344,683 "),
                            createTextVNode(" cis-meQTL pairs and "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 4,002,871 "),
                            createTextVNode(" trans-meQTL pairs from SNVs, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 392,720 "),
                            ...
                            createTextVNode(" trans-meQTL pairs from InDels, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 296,675 "),
                            ...
                            createTextVNode(" trans-meQTL pairs from MNVs, and "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 21,305 "),
                            ...
                            createTextVNode(" trans-meQTL pairs from SVs."),
                            createVNode("br")
                          ])
                        ];
                      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/meQTL.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=meQTL.vue.mjs.map
