              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-px-md q-py-sm text-subtitle2 text-primary text-bold" style="${ssrRenderStyle({ "background-color": "#e3f2fd", "font-size": "20px", "line-height": "1.3" })}"${_scopeId3}> Search apaQTL by Variant or Gene </div>`);
                      } else {
                        return [
                          createVNode("div", {
                          ...
                          }, " Search apaQTL by Variant or Gene ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "q-px-md q-pt-md q-pb-sm" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-body1 text-grey-8" style="${ssrRenderStyle({ "line-height": "1.5" })}"${_scopeId3}> This module provides <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 1,372,722 </span> apaQTLs identified across 148 healthy Chinese individuals, revealing genetic variants that regulate polyadenylation site usage in <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 41,860 </span> APA events. The apaQTL dataset encompasses associations from multiple variant types, including <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 31,997 </span> cis-apaQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 1,172,375 </span> trans-apaQTL pairs from SNVs, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 2,408 </span> cis-apaQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 87,276 </span> trans-apaQTL pairs from InDels, <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 1,476 </span> cis-apaQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 63,483 </span> trans-apaQTL pairs from MNVs, and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 134 </span> cis-apaQTL pairs and <span class="text-bold rounded-borders q-px-xs" style="${ssrRenderStyle({ "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" })}"${_scopeId3}> 13,573 </span> trans-apaQTL pairs from SVs.<br${_scopeId3}></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            ...
                            createTextVNode(" apaQTLs identified across 148 healthy Chinese individuals, revealing genetic variants that regulate polyadenylation site usage in "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 41,860 "),
                            createTextVNode(" APA events. The apaQTL dataset encompasses associations from multiple variant types, including "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 31,997 "),
                            createTextVNode(" cis-apaQTL pairs and "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 1,172,375 "),
                            createTextVNode(" trans-apaQTL pairs from SNVs, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 2,408 "),
                            ...
                            createTextVNode(" trans-apaQTL pairs from InDels, "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 1,476 "),
                            ...
                            createTextVNode(" trans-apaQTL pairs from MNVs, and "),
                            createVNode("span", {
                              class: "text-bold rounded-borders q-px-xs",
                              style: { "padding-left": "0", "margin-left": "0", "color": "red", "background-color": "white" }
                            }, " 134 "),
                            ...
                            createTextVNode(" trans-apaQTL pairs from SVs."),
                            createVNode("br")
                          ])
                        ];
                      }
                  ...
                  _push3(ssrRenderComponent(_component_q_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`</div></div><div class="row"${_scopeId3}><div class="col-12 col-sm-8 items-center justify-between q-my-xs"${_scopeId3}><span class="text-bold text-subtitle2 text-primary q-px-sm"${_scopeId3}>Gene ID:</span>`);
                        _push4(ssrRenderComponent(_component_q_select, {
                          dense: "",
                          outlined: "",
                          clearable: "",
                        ...
                        return [
                          ...
                          createVNode("div", { class: "row" }, [
                            createVNode("div", { class: "col-12 col-sm-8 items-center justify-between q-my-xs" }, [
                              createVNode("span", { class: "text-bold text-subtitle2 text-primary q-px-sm" }, "Gene ID:"),
                              createVNode(_component_q_select, {
                                dense: "",
                                outlined: "",
                                clearable: "",
                  ...
                  _push3(`<div class="row justify-center q-pb-md q-my-xs"${_scopeId2}><div class="q-px-sm q-gutter-x-xs"${_scopeId2}><!--[-->`);
                  ...
                  return [
                    ...
                    createVNode("div", { class: "row justify-center q-pb-md q-my-xs" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/apaQTL.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=apaQTL.vue.mjs.map
