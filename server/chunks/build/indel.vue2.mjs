...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const examples = [
      {
        label: "example1",
        variantID: "chr14_76726181_GGCGCCCGCCACC_G",
        phenotypeType: "eQTL",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_q_card_section, { class: "row q-py-none q-px-none" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1"${_scopeId3}> Search InDel-QTL by Variant or Phenotype </div>`);
                      } else {
                        return [
                          createVNode("div", { class: "full-width q-py-sm q-px-md bg-indigo-1 text-primary text-bold text-subtitle1" }, " Search InDel-QTL by Variant or Phenotype ")
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/qtl/indel.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=indel.vue2.mjs.map
