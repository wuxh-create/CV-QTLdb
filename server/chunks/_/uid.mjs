import { getCurrentInstance, onDeactivated, onBeforeUnmount, nextTick } from 'vue';
import { v as vmIsDestroyed } from './QBtn.mjs';
...
export { useTick as a, uid as b, useTimeout as u };
