import { getCurrentInstance, ref, computed, watch, provide, onBeforeUnmount, onDeactivated, onActivated, h, inject, onMounted, withDirectives } from 'vue';
import { _ as __nuxt_component_4 } from './QIcon.mjs';
import { Q as QResizeObserver } from './QResizeObserver.mjs';
import { a as useTick, u as useTimeout, b as uid } from './uid.mjs';
import { g as createComponent, F as tabsKey, j as emptyRenderFn, s as stopAndPrevent, x as isDeepEqual } from '../build/server.mjs';
import { h as hSlot, b as hMergeSlot } from './render.mjs';
import { R as Ripple, i as isKeyCode, s as shouldIgnoreKey } from './QBtn.mjs';
...
export { __nuxt_component_2 as _, useTabProps as a, useTab as b, useTabEmits as u };
