...
import { l as buildAssetsURL, u as useRuntimeConfig, m as getResponseStatusText, n as getResponseStatus, o as defineRenderHandler, p as publicAssetsURL, g as getQuery, c as createError, q as getRouteRules, r as useNitroApp, t as readBody, v as destr } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"A database for Variant-Phenotype associations data"},{"name":"keyword","content":"QTL"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/CV-QTLdb/favicon.ico"}],"style":[{"children":".nuxt-loading-indicator { display: none !important; opacity: 0 !important; visibility: hidden !important; height: 0 !important; }","type":"text/css"}],"script":[],"noscript":[],"title":"CV-QTLdb","htmlAttrs":{"lang":"en"}};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.I; }).then((r) => r.default || r);
