  ...
  <q-page class="q-mx-auto" style="min-height: calc(100vh - 180px); padding-top: 0;">
    ...
    <div
      ...
      :class="{
        ...
        'bg-indigo-1 text-indigo-8': !$q.dark.isActive,
      }"
    >
      <q-card
        flat
      ...
      >
        <q-card-section class="text-h5 text-bold text-left">
          {{ "Welcome to CV-QTLdb!" }}
        </q-card-section>
        <q-card-actions class="text-h6 q-px-lg text-left">
          CV-QTLdb provides query and visualization tools for genetic variants,
          MolQTL information, and correlations between variations and clinical
          traits, aiming to support researchers with a comprehensive resource
          for functional interpretation of complex genetic variations and
        ...
        <div class="row">
          <div class="col-sm-9">
            <q-card-section class="q-px-lg q-pt-md">
              <div class="text-h6 text-bold text-left q-mb-md">
                In <strong>dbQTLVar</strong>, users can:
              </div>
              <div class="feature-list">
                <div class="feature-item">
                  <q-icon name="check" color="#ff3333" size="28px" class="feature-icon bold-icon" />
                  <span class="feature-text">Search for 4 types of variants, including SNPs, InDels, MNVs, and SVs</span>
                </div>
                <div class="feature-item">
                  <q-icon name="check" color="#ff3333" size="28px" class="feature-icon bold-icon" />
                  <span class="feature-text">Search for associations between molQTL (eQTL,apaQTL,sQTL,meQTL) and 4 types of variants</span>
                </div>
                <div class="feature-item">
                  <q-icon name="check" color="#ff3333" size="28px" class="feature-icon bold-icon" />
                  <span class="feature-text">Search for GWAS associations of 180+ clinic traits across 4 types of variants</span>
                </div>
                <div class="feature-item">
                  <q-icon name="check" color="#ff3333" size="28px" class="feature-icon bold-icon" />
                  <span class="feature-text">Obtain the correlation between QTLs and 180+ clinical traits</span>
                </div>
              </div>
            </q-card-section>
          </div>
