    ...
    <q-card flat bordered style="max-width: 1140px" class="q-mx-auto q-my-none">
      ...
      <q-card-section class="q-px-md q-pt-md q-pb-sm">
        <div class="text-body1 text-grey-8" style="line-height: 1.7;">
          ...
          linking genetic variants to the expression levels of 78,279 protein-coding genes quantified from RNA-sequencing data. 
          The eQTL pages comprises associations derived from four variant types: 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            246,966 
          </span>
          SNV-eQTL pairs regulating 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            2,783
          </span>
          genes, 
          ...
          SV-eQTL pairs regulating 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            706
          </span>genes.
          <br> 
          <!-- eQTLs were mapped using linear regression models implemented in 
          ...
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              cis-eQTLs (variant-gene distance ≤ 1 Mb)
          </span>
           or 
           <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              trans-eQTLs (distance > 1 Mb),
          </span> 
