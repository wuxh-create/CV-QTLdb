    ...
    <q-card flat bordered style="max-width: 1140px" class="q-mx-auto q-my-none">
      ...
      <q-card-section class="q-px-md q-pt-md q-pb-sm">
        <div class="text-body1 text-grey-8" style="line-height: 1.5;">
          ...
          apaQTLs identified across 148 healthy Chinese individuals, 
          revealing genetic variants that regulate polyadenylation site usage in 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            41,860
          </span>
          APA events. 
          The apaQTL dataset encompasses associations from multiple variant types, including 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            31,997
          </span>
          cis-apaQTL pairs and 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            1,172,375
          </span>
          trans-apaQTL pairs from SNVs, 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            2,408
          </span>
          cis-apaQTL pairs and 
          ...
          trans-apaQTL pairs from InDels, 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            1,476
          </span>
          cis-apaQTL pairs and 
          ...
          trans-apaQTL pairs from MNVs, and 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            134
          </span>
          cis-apaQTL pairs and 
          ...
          trans-apaQTL pairs from SVs.<br>
          <!-- Alternative polyadenylation events were identified and quantified using 
          ...
          which leverages UTR-level expression data from Salmon to determine polyadenylation site usage (PAU) across samples. 
          APA events with > 5% missing values were excluded from analysis to ensure data quality. 
          <br> -->
          <!-- apaQTLs were mapped using linear regression models implemented in 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              MatrixEQTL,
          </span>
          ...
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              cis-apaQTLs (variant-gene distance ≤ 1 Mb)
          </span>
           or 
           <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              trans-apaQTLs (distance > 1 Mb),
          </span> 
