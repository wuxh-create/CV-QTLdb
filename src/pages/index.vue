      ...
      <q-card flat class="col-12 q-my-xs content-card">
        ...
        <q-card-section class="row text-body2 text-foreground text-justify section-content">
          <p class="intro-text">
            ...
            represent quantitative trait loci associated with four major classes of genetic variations.
            It incorporates a systematically curated collection of variants, including single nucleotide variants (SNVs) and diverse complex variants (CVs) such as insertions and deletions (InDels), 
            multi-nucleotide variants (MNVs), and structural variants (SVs). The
            <span class="highlight-text">
              CV-QTLdb
            </span>
            provides integrated query and visualization tools for these genetic variants, molecular quantitative trait locus (molQTL) annotations 
            such as 
            expression QTLs (eQTLs), splicing QTLs (sQTLs), alternative polyadenylation QTLs (apaQTLs), and methylation QTLs (meQTLs), 
            as well as associations between genetic variations and clinical measurements. 
            This comprehensive resource aims to facilitate the functional interpretation of complex genetic variations and advance mechanistic insights in human genetics.
          </p>
            ...
            <q-card-section class="info-section">
              ...
              <ul class="no-margin q-pl-lg q-py-xs custom-bullet-list">
                <li class="q-pa-xs list-item">
                  Comprehensive data for four variant types;
                </li>
                <li class="q-pa-xs list-item">
                  Association analysis between four variant types and four molecular phenotypes;
                </li>
                <li class="q-pa-xs list-item">
                  GWAS associations for 162 clinical measurements across four variant types;
                </li>
                <li class="q-pa-xs list-item">
                  Co-localization analysis between molecular phenotypes and clinical measurements;
                </li>
              </ul>
            </q-card-section>
          </q-card>
          ...
          <q-card flat class="info-card" style="border: 1px solid white;">
            <q-card-section class="info-section">
              ...
              <ul class="no-margin q-pl-lg q-py-xs checkmark-list">
                <li class="q-pa-xs list-item">
                  Query and browse four variant types.
                </li>
                <li class="q-pa-xs list-item">
                 Explore associations between four variant types and four molecular phenotypes.
                </li>
                <li class="q-pa-xs list-item">
                  Search GWAS associations for 162 clinical measurements across four variant types.
                </li>
                <li class="q-pa-xs list-item">
                  Analyze correlations between molecular phenotypes and clinical measurements.
                </li>
              </ul>
            </q-card-section>
          </q-card>
          ...
          <div class="chart-display-area">
            <div class="chart-row">
              <q-card
                ...
                :class="getPhenotypeBorderClass(phenotype)"
                flat
                bordered
          ...
          <div class="chart-display-area">
            <div class="chart-row">
              <q-card
                ...
                :key="variantType"
                class="chart-card clickable-card"
                :class="getVariantTypeBorderClass(variantType)"
                flat
                bordered
...
// 获取phenotype的边框颜色类(第一排)
const getPhenotypeBorderClass = (phenotype: string) => {
  // Clinic traits 使用黑色边框，其他使用红色边框
  return phenotype === 'Clinic traits' ? 'black-border' : 'red-border'
}

// 获取变异类型的边框颜色类(第二排)
const getVariantTypeBorderClass = (variantType: string) => {
  // Correlation 使用黑色边框，其他使用红色边框
...
.chart-row {
  display: flex;
  flex-wrap: wrap;
  gap: 12px; /* 修改: 从0px改为12px，增加图形框之间的间距 */
...
.chart-card {
  ...
  background: rgba(255, 255, 255, 0.95);
  backdrop-filter: blur(10px);
  border-width: 1px !important; /* 增加边框宽度使颜色更明显 */
  overflow: hidden;
  margin: 0;
  transition: all 0.3s ease;
}
...
/* 新增: 红色边框类 */
.red-border {
  border-color: rgb(152, 206, 250) !important;
  // rgb(250, 235, 152)
}

/* 新增: 黑色边框类 */
.black-border {
  border-color: rgb(212, 175, 243) !important;
}
...
/* 红色边框的悬停效果 */
.clickable-card.red-border:hover {
  box-shadow: 0 6px 16px rgba(255, 0, 0, 0.3);
}

/* 黑色边框的悬停效果 */
.clickable-card.black-border:hover {
