    ...
    <q-card flat bordered style="max-width: 1140px" class="q-mx-auto q-my-none">
      ...
      <q-card-section class="q-px-md q-pt-md q-pb-sm">
        <div class="text-body1 text-grey-8" style="line-height: 1.7;">
          ...
          sQTLs identified across 148 healthy Chinese individuals, 
          revealing genetic variants that regulate alternative splicing patterns in 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            151,458
          </span>
          splicing events. 
          The sQTL dataset encompasses associations from multiple variant types, 
          including 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            438,397
          </span>
          ...
          trans-sQTL pairs from MNVs, and
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: red; background-color: white;">
            2,433
          </span>
          cis-sQTL pairs and 
          ...
          trans-sQTL pairs from SVs.
          <br>
          <!-- Alternative splicing events were identified and quantified using 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              LeafCutter,
          </span> 
          which leverages RNA-sequencing reads spanning introns to quantify differential intron usage across samples without requiring genome annotations.
           <br> -->
          <!-- sQTLs were mapped using linear regression models implemented in 
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              MatrixEQTL,
          </span>
          ...
          <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              cis-sQTLs (variant-gene distance ≤ 1 Mb)
          </span>
           or 
           <span class="text-bold rounded-borders q-px-xs" style="padding-left: 0; margin-left: 0; color: #f57c20; background-color: white;">
              trans-sQTLs (distance > 1 Mb),
          </span> 
